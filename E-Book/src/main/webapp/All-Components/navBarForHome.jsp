    ...
    <div class="row">
        ...
        <c:if test="${not empty userobj}">
            <div class="col-md-3">
                ...
                <a href="" class="btn mb-2 btn-success "><i class="fa-solid fa-user"></i> ${userobj.name } </a>
                <a href="LogoutServlet" class="btn mb-2 btn-primary "><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
            </div>
        </c:if>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#RecentBook"><i class="fa-solid fa-book-open-reader"></i> Recent Book <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="#NewBook"><i class="fa-solid fa-book-open-reader"></i> New Book <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="#OldBook"><i class="fa-solid fa-book-open-reader"></i> Old Book <span class="sr-only">(current)</span></a>
            </li>
        </ul>
    </div>
    ...
    <form class="form-inline my-2 my-lg-0">
        ...
        <button class="btn btn-outline-primary  my-2 my-sm-0 ml-1" type="button">
