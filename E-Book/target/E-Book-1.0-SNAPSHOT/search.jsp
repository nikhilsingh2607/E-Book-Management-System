...
<html>
    ...
    <body>
        ...
        %>
            <h3 class="text-center mt-1" id="RecentBook">Books</h3>
            <div class="row p-3">
                    <%
                       String str = request.getParameter("str");
                        BookDAOImpl dao = new BookDAOImpl(DBConnector.getConnection());
                        List<BookDtlsDTO> list = dao.getBookBySearch(str);
                            ...
                            <div class="row">
                             <%if(b.getBookCategory().equals("NewBook"))
                               ...
                               <%}%>
                                ...
                                <a  class="btn btn-sm btn-danger ml-1"><i class="fa-solid fa-indian-rupee-sign"></i> <%=b.getPrice()%></a>
                                <%}%>
                            </div>
                        </div>
                    </div> 
